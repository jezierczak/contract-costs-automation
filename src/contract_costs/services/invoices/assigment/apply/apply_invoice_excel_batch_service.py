from contract_costs.services.invoices.assigment.apply.apply_company_excel_batch_service import ApplyCompanyExcelBatchService
from contract_costs.services.invoices.assigment.invoice_sources.dto.common import InvoiceExcelBatch
...
class ApplyInvoiceExcelBatchService:
    ...
    def apply(self, batch: InvoiceExcelBatch) -> None:
        ...
        ingest_batch = self._excel_resolver.resolve(batch)
