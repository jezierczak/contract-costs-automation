...
#                  company_candidate_provider: CompanyCandidateProvider,
#                  llm_company_resolver: OpenAIInvoiceClient
#                  ) -> None:
#         self._company_repo = company_repo
#         self._company_candidate_provider = company_candidate_provider
...
#
#             candidates = self._company_candidate_provider.find_candidates(input_)
