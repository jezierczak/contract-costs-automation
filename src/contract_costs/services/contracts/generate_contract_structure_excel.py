...
class GenerateContractStructureBundleService:
    ...
    @staticmethod
    def generate_empty() -> ContractStructureBundle:
        return ContractStructureBundle(
            contract=None,
            cost_nodes=[],
        )
