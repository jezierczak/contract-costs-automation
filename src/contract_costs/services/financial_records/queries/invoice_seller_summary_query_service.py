...
#     def __init__(
#         self,
#         invoice_repo: FinancialRecordRepository,
#         invoice_line_repo: FinancialRecordLineRepository,
...
#
#         for inv in invoices:
#             if inv.status != FinancialRecordStatus.PROCESSED:
#                 continue
#             lines = self._line_repo.list_by_financial_record_ids([inv.id])
