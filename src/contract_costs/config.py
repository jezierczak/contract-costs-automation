...
DICTS_PROJECT_CONTRACTS ="DICTS_PROJECT_CONTRACTS"
DICTS_AGREEMENT_CONTRACTS = "DICTS_AGREEMENT_CONTRACTS"
DICTS_PROJECT_COST_NODES ="DICTS_PROJECT_COST_NODES"
DICTS_AGREEMENT_COST_NODES = "DICTS_AGREEMENT_COST_NODES"
